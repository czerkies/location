<div class="infos_1">
  ...
  <div class="slide">
    <img class="img1" src="<?= RACINE_SITE; ?>photoslide/location_salle_1.jpg" alt="Lokisalle 1">
    <img class="img2" src="<?= RACINE_SITE; ?>photoslide/location_salle_2.jpg" alt="Lokisalle 2">
    <img class="img3" src="<?= RACINE_SITE; ?>photoslide/location_salle_3.jpg" alt="Lokisalle 3">
    <img class="img4" src="<?= RACINE_SITE; ?>photoslide/location_salle_4.jpg" alt="Lokisalle 4">
  </div>
