<div class="infos_1">
  ...
  <p>Lokisalle est un service de location de salles, clef en main. Les meilleures salles vous sont proposées pour un prix imbattable. Elles vous seront utiles pour vos réunions, conférences ou formations que vous soyez particuliers ou professionnels.<br><br>
  ...
  Si vous avez des questions ou autres demandes, <a href="<?= RACINE_SITE; ?>contact/">contactez-nous</a> !</p>
</div>
<div id="last3offres">
