<div class="menu_admin">
  <ul>
    <li><a href="routeur.php?controleurs=salles&action=gestionSalles">Gestion des salles</a></li>
    <li><a href="routeur.php?controleurs=produitAdmin&action=afficherProduits">Gestion des produits</a></li>
    <li><a href="routeur.php?controleurs=membreAdmin&action=gestionMembres">Gestion des membres</li>
